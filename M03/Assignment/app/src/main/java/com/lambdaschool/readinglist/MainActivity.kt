...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirebaseAnalytics.getInstance(this).setCurrentScreen(this, "MainActivity", "Normal")
        ...
        if (requestCode == Constants.NEW_BOOK_REQUEST_CODE && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                if (bookCSV != null){
                    ...
                    val bundle = Bundle()
                    bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, book.title)
                    bundle.putString(FirebaseAnalytics.Param.CONTENT, book.reasonToRead)
                    bundle.putBoolean(FirebaseAnalytics.Param.ACHIEVEMENT_ID, book.isHasBeenRead)
                    FirebaseAnalytics.getInstance(this).logEvent("bool_added", bundle)
                }
            }
        }
